$(document).ready(function () {
  ...
  $(".add-to-wishlist").click(function (e) {
    ...
    console.log("Adding to wishlist, product ID:", p_id); // Debugging
    ...
    $.ajax({
      ...
      error: function (jqXHR, textStatus, errorThrown) {
        console.error("Error adding to wishlist:", textStatus, errorThrown); // Debugging
      },
    });
  });
