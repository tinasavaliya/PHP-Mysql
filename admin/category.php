...
<div class="admin-content-container">
    ...
    <a class="add-new pull-right float-end btn-golden mb-lg-3 mb-2 fw-700 fs-15" href="add_category.php">Add New</a>
    <?php
    $page = isset($_GET['page']) ? (int)$_GET['page'] : 1;
    $limit = 2;
    $offset = ($page - 1) * $limit;
    $categories = "SELECT * from categories order  by categories.id DESC LIMIT $limit";
    $row = mysqli_query($conn, $categories) or die("Query failed");
