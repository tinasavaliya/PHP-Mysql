            ...
            <form id="updateOptions" class="add-post-form row" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <img class="mt-lg-2" id="image" src="../images/<?php echo $row['site_logo']; ?>" alt="" width="100px"/>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-12 mb-lg-4 mb-2 mt-lg-3 mt-2">
                    <div class="form-group">
                        <input type="submit" class="btn-golden fs-15 fw-700 text-white" name="submit" value="Update">
                    </div>
                </div>
            </form>
        <?php
