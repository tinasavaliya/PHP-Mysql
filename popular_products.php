    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                $offset = ($page - 1) * $limit;
                $products = "select * from products order by product_views DESC, product_views > 0 AND product_status = 1 AND qty > 0";
            ...
            <div class="col-md-12 pagination-outer">
                <?php
                $total_pages_sql = "SELECT COUNT(*) FROM products WHERE product_views > 0 AND product_status = 1 AND qty > 0";
                ...
                for ($i = 1; $i <= $total_pages; $i++) {
                    if ($total_rows == $limit) {
                        ...
                        echo '<li><a href="?products=' . $total_rows . '&page=' . $i . '">' . $i . '</a></li>';
                    }
                }
                echo '</ul>';
                ?>
