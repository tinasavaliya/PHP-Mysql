...
if (isset($_POST['addCart'])) {
    ...
    if (setcookie('user_cart', $u_cart, time() + (86400 * 30), '/', '', false, true)) {
        setcookie('cart_count', $cart_count, time() + (86400 * 30), '/', '', false, true);
...
if (isset($_POST['addWishlist'])) {
    ...
    if (setcookie('user_wishlist', $u_wishlist, time() + (86400 * 30), '/', '', false, true)) {
        setcookie('wishlist_count', $wishlist_count, time() + (86400 * 30), '/', '', false, true);
        echo 'wishlist cookie set successfully';
    } else {
        echo 'false';
    }
    exit;
