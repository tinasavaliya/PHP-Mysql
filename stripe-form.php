...
if (isset($_COOKIE['user_cart'])) {
    ...
    $pids = implode(',', $pid);
    $products_query = "SELECT product_id, product_title, product_price, featured_image FROM products WHERE product_id IN ($pids)";
...
<body>
    ...
    <div class="container">
        <h2 style="text-align: center; color: blue;">Book payment </h2>
        <br>
        <div class="row">
                ...
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="stripe_payment.php" method="POST" name="cardpayment" id="payment-form">
                            ...
                            ?>
                            <input type="hidden" name="productId" value="<?php echo $row['product_title']; ?>" />
                                <div class="row">
                                    <div class="col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <button class="subscribe btn btn-success btn-lg btn-block submit" type="submit" id="payBtn">PAY NOW ( $<?php echo $row['product_price']; ?> )</button>
                                    </div>
                                </div>
                            <?php } ?>
                        </form>
